...
<table>
    <tr>
        <td width="30%" valign="top"style="border: none; ">
            <br><a href="https://www.magezon.com/magento-2-pdf-customizer.html"><img src="https://www.magezon.com/pub/media/catalog/product/cache/c56f5c50a53ae6d445bac4bece78644e/m/a/magento_2_pdf_customizer_-_logo.jpg">
            </a>
        </td>
        <td style="border:none;"></br>
            ...
            <div>
                <h3>
                    Demo <a href="http://demo.magezon.com/pdf/sales/order/view/order_id/11/" rel="nofollow">Fontend</a> - <a href="http://demo.magezon.com/pdf/autologin/backend?r=mgzpdf/template/edit&template_id=1" rel="nofollow">Backend</a>
                </h3>
            </div>
        </td>
    </tr>
...
<div>
    ...
    <table>
        ...
        <tr id="create-beautiful" align="center">
            ...
            <td colspan="6" width="50%">
                <div class="col-md-6">
                    <p><img src="https://www.magezon.com/pub/media/pdf_customizer/Magento_2_PDF_Customizer_4_types_supported.png" alt="Magento 2 PDF Customizer | 4 PDF Type Supported"></p>
                </div>
            </td>
        </tr>
        <tr id="drag-drop">
        ...
        <tr>
            ...
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/2.textblock.png" alt="Magento 2 PDF Customizer | Text Block" width="80" height="80" title="">
                <h4>Text Block</h4>
            </td>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/3.heading.png" alt="Magento 2 PDF Customizer | Heading" width="80" height="80" title="">
                <h4>Heading</h4>
            </td>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/4.separator.png" alt="Magento 2 PDF Customizer | Separator" width="80" height="80" title="">
                <h4>Separator</h4>
            </td>
        </tr>
        <tr></tr>
        <tr>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/5.image.png" alt="Magento 2 PDF Customizer | Single Image" width="80" height="80" title="">
                <h4>Single Image</h4>
            </td>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/6.site-logo.png" alt="Magento 2 PDF Customizer | Single Image" width="80" height="80" title="">
                <h4>Site Logo</h4>
            </td>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/9.field.png" alt="Magento 2 PDF Customizer | Variable" width="80" height="80" title="">
                <h4>Field</h4>
            </td>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/8.Items.png" alt="Magento 2 PDF Customizer | Items" width="80" height="80" title="">
                <h4>Item</h4>
            </td>
        </tr>
        <tr></tr>
        <tr>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/7.total.png" alt="Magento 2 PDF Customizer | Totals" width="80" height="80" title="">
                <h4>Totals</h4>
            </td>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/12.barcode.png" alt="Magento 2 PDF Customizer | Bar Code" width="80" height="80" title="">
                <h4>Bar Code</h4>
            </td>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/11.qrcode.png" alt="Magento 2 PDF Customizer | QR Code" width="80" height="80" title="">
                <h4>QR Code</h4>
            </td>
            <td colspan="3" width="25%" align="center">
                <img class="mgz-hover-main" src="https://www.magezon.com/pub/media/pdf_customizer/10.link.png" alt="Magento 2 PDF Customizer | Link" width="80" height="80" title="">
                <h4>Link</h4>
            </td>
        </tr>
        <tr id="pre-built">
        ...
        <tr>
            <td colspan="4" width="33%" valign="baseline">
                <div align="center">
                    <img src="https://www.magezon.com/pub/media/wysiwyg/premium-online-support.png" alt="Premium Online Support" height="auto" width="160" data-canonical-src="https://www.magezon.com/pub/media/ninjamenus2/premium-online-support.png">
                </div>
